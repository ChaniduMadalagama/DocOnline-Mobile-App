...
public class SpecialistAdapter extends RecyclerView.Adapter<SpecialistAdapter.CardViewHolder> {
    ...
    ArrayList<com.chanidu.edocter.SpecialistModel> CardLocations;
    RecyclerViewClickListener listener;

    public SpecialistAdapter(ArrayList<com.chanidu.edocter.SpecialistModel> CardLocations, RecyclerViewClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        com.chanidu.edocter.SpecialistModel cardHelperClass = CardLocations.get(position);
