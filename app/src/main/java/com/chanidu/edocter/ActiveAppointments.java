...
public class ActiveAppointments extends AppCompatActivity {
    ...
    private void Appointments() {
        ...
        FirebaseRecyclerOptions<com.chanidu.edocter.ActiveAppointmentsModel> options =
                new FirebaseRecyclerOptions.Builder<com.chanidu.edocter.ActiveAppointmentsModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("patients").child(PatientDashboard.UserName).child("active_app"),
                                com.chanidu.edocter.ActiveAppointmentsModel.class)
                        .build();
